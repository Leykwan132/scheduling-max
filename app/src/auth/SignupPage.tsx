    ...
    <AuthPageLayout>
      ...
      <div className="mt-8 text-center">
        <span className="text-sm font-bold text-gray-600">
          ...
          <WaspRouterLink to={routes.LoginRoute.to} className="underline text-black decoration-2 underline-offset-2 hover:text-purple-600 hover:decoration-purple-600 transition-all">
            go to login
          </WaspRouterLink>
          ).
        </span>
